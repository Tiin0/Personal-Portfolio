...
function Intro() {
    return (
        <div className='w-full min-h-[calc(100vh-80px)] flex justify-center overflow-hidden'> 
            <div data-animation="fade-up" className='lg:w-full h-auto flex flex-col justify-center items-center xs:w-[80%] sm:w-[90%] opacity-0'>
                <h1 className="sm:text-7xl text-center tracking-wide xs:text-6xl font-lobster xs:leading-18 sm:leading-21">Hi!, my name is <strong className='text-[#B8860B]'>Tino</strong></h1>
