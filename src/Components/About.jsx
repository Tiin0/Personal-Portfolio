    ...
    return (
        <div className="w-full h-auto flex flex-col items-center" id='about'> {/* Wrapper */}
            <div className="xs:w-[80%] lg:w-full h-full mt-25"> {/* w-full declaration */}
                  <h1 data-aos="fade-down" className="font-extrabold text-6xl text-[#B8860B] text-center font-calSans tracking-wider">About</h1>
                  <p data-aos="fade-up" className="text-center max-w-2xl mx-auto mt-10 font-semibold xs:text-xl sm:text-2xl font-adlam">
