...
function Card(props) {
    return (
        <div
            ...
            className="group relative lg:w-50 lg:h-50 xs:w-45 xs:h-45 border border-black dark:border-white shadow-2xl flex items-center justify-center rounded-lg overflow-hidden bg-white dark:bg-[#2c2c2c] opacity-0"
        >
